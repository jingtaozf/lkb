...
##
  ...
  set maxWindowWidth 1000; 		# Maximum width of toplevel window
  set maxWindowHeight 700;		# Maximum height of toplevel window
  ...
  button $toplevel.adjust -text "Adjust" -command "table_adjust $toplevel"
  ...
  table $toplevel \
      ...
      1,1 $toplevel.adjust -pady {5 10} \
      1,2 $toplevel.latex -pady {5 10} \
