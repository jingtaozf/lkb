...
proc graph_postscript {graph name} {
  ...
  $graph postscript output $file -landscape yes -paperheight 29.7c \
      -paperwidth 21c -decoration no
   run_meter 500;
...
proc read_graph_file {file graph} {
	...
	switch $command {
	    barchart -
	    graph    { 
              set graphtype $command; set graphoptions [lrange $line 1 end] 
            }
...
proc make_graph {graph} {
    ...
    ##
    global graphtype graphoptions data axis element labels legend
