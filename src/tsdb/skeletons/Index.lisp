...
(((:path . "english") (:content . "English TSNLP Test Suite"))
 ((:path . "french") (:content . "French TSNLP Test Suite"))
 ((:path . "german") (:content . "German TSNLP Test Suite"))
 ((:path . "csli") (:content . "English CSLI (LinGO) Test Suite"))
 ((:path . "evm") (:content . "English VerbMobil Data"))
 ((:path . "s+w") (:content . "[Sag & Wasow 1998] Examples"))
 ((:path . "toy") (:content . "English `toy' Test Suite")))
