...
(defun gen-chart-adjoin-modifiers (partial-edges input-rels possible-grules)
   ...
   (let
      ...
      (let*
         ...
         ;; perform all possible adjunctions of modifiers into others e.g. to get nested PPs
         ;; -- note that after doing this some of the modifiers may have supersets of
         ;; rels-covered unpackable from them
