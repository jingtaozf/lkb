...
(let ((target (dir-append sys-home (list :relative "fspp"))))
  ...
  (print (when (pll-file) (file-namestring (pll-file))))
  ...
  (excl:generate-application 
   ...
   (list :srecord
         :eli
         :sock
         (merge-pathnames #p"src/preprocess/fspp-image/build_standalone.lsp" sys-home))
