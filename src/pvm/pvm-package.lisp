...
(defpackage "PVM"
  ...
  (:export
   ...
   "MAKE-CPU" "COPY-CPU"
   "CPU-P" "CPU-HOST" "CPU-SPAWN" "CPU-OPTIONS" "CPU-ENCODING"
   "CPU-ARCHITECTURE" "CPU-CLASS" "CPU-TASK" "CPU-FLAGS" "CPU-THRESHOLD" 
   "CPU-NAME" "CPU-GRAMMAR" "CPU-TEMPLATE" "CPU-LANGUAGE"
   "CPU-EDGES" "CPU-ANALYSES" "CPU-RESULTS" "CPU-WAIT" "CPU-QUANTUM"
   "CPU-PREPROCESSOR" "CPU-TAGGER" "CPU-READER"
   "CPU-CREATE" "CPU-COMPLETE"
   "MAKE-CLIENT" "COPY-CLIENT"
   "CLIENT-P" "CLIENT-TID" "CLIENT-CPU" "CLIENT-TASK"
