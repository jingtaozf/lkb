...
cl-user::all-speed-items cl-user::toggle-edge-caches
         ...
         (list
              (make-lkb-submenu-item :menu-title "Load"
                 :menu-items
                  ...
                  :available-p t)
              (make-lkb-submenu-item :menu-title "Speed"
                 :menu-items
                  (list 
                     (make-menu-item :name "Everything"
                        :value 'all-speed-items)
                     (make-menu-item :name "Toggle edge cache"
                        :value 'toggle-edge-caches)
                     (make-menu-item :name "Type compatability"
                        :value 'set-up-type-cache))
               :available-p nil)
