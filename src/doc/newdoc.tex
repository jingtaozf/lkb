...
\begin{enumerate}
\item Create a temporary directory (see \S\ref{tmpdir}).
...
create a temporary directory (see \S\ref{tmpdir}).
To continue, see Chapter~\ref{firstsession}.
...
The behaviour is very different in MCL and ACL:
...
can be run from the {\bf Generate} menu.
