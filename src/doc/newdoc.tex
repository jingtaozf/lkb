...
We would suggest 32 Meg of RAM as a minimum on MCL, and 64 Meg for ACL with CLIM.
...
if you want to make a Lisp image, execute \verb+(dump-lkb)+.
...
The LKB system can be started from the image as described in 
\S\ref{emacs-image}.
% FIX ??
...
frequent changes in the code or if you are setting up the LKB for
a group of users who won't be modifying the code.
Calling {\tt (dump-lkb)} will end your Lisp session.
