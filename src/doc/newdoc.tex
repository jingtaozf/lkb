...
\item Construct a fasl directory tree.  The system assumes that there
is a directory named according to the type of system you have
...
\begin{enumerate}
\item Construct a fasl directory.  The system assumes that there
is a directory named according to the type of system you have
(search for {\tt BINARY-DIR-NAME} in the {\tt general} files).
On the version of MCL we have tested this on,
the directories are constructed automatically if they don't exist,
so you may not need to bother with this step.
