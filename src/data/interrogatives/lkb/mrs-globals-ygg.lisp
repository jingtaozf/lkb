...
(defparameter *initial-semantics-path* `(,(vsym "SS") ,(vsym "LOC") ,(vsym "CONT")))

;;;(defparameter *initial-semantics-path* `(,(vsym "SS") ,(vsym "LOC") ,(vsym "CONT")  ,(vsym "SOA") ,(vsym "NUCL")))

(defparameter *main-semantics-path* `(,(vsym "SS") ,(vsym "LOC")  ,(vsym "CONT")  ,(vsym "SOA") ,(vsym "NUCL")))

(defparameter *top-semantics-type* (vsym "RELN"))

(defparameter *construction-semantics-path* `(,(vsym "SS") ,(vsym "LOC")  ,(vsym "CONT")))
