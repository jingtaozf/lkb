...
table . .color       1,0 -columnspan 2 -fill both -padx 4 -pady 4
table . .redScale    2,0 -fill both
table . .redSample   2,1 -fill both
table . .greenScale  3,0 -fill both
table . .greenSample 3,1 -fill both
table . .blueScale   4,0 -fill both
table . .blueSample  4,1 -fill both
